...
export default function AdsDashboard() {
  ...
  const quickLinks = [
{ title: "Ad Campaigns", description: "Manage all ad campaigns", icon: TrendingUp, path: "/marketing/ads/campaigns", gradient: "from-blue-500 to-blue-600", bg: "from-blue-50 to-blue-100 dark:from-blue-950/40 dark:to-blue-900/20" },
