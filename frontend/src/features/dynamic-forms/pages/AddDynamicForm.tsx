...
import { createForm } from "../services/dynamicFormService";
...
export default function AddDynamicForm() {
    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => navigate("/settings/dynamic-forms")}
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-2 text-lg">
            Build a new dynamic form and assign it to modules.
          </p>
        </div>
      </div>
      ...
      {success && (
        <div className="rounded-xl border-2 border-green-300 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 p-5 flex items-center gap-3 shadow-lg animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <div>
            <p className="font-bold text-green-700 dark:text-green-300 text-lg">Form Created!</p>
