...
interface LeadToolbarProps {
  ...
  onAssignedToChange: (employee: string) => void;
}
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search by lead name, company, contact person, email..."
            value={searchQuery}
      ...
      <div className="rounded-lg bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 border border-blue-200/50 dark:border-blue-800/50 p-4">
        <p className="text-sm text-blue-700 dark:text-blue-300">
          💡 <span className="font-semibold">Pro Tip:</span> Use filters to track leads by status, source, and assigned team member
        </p>
      </div>
    </div>
  );
