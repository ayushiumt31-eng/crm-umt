...
interface SocialCampaignStatusBadgeProps {
  status: SocialCampaignStatus;
  className?: string;
}

const statusConfig: Record<SocialCampaignStatus, string> = {
  DRAFT:
...
export function SocialCampaignStatusBadge({
  status,
  className = "",
}: SocialCampaignStatusBadgeProps) {
